"""
Django settings for bluebuttondev project.
...
THIRD_PARTY_APPS = (
    ...
    'oauth2_provider', # pip install django-oauth2-provider
    'corsheaders', # pip install django-cors-headers
    'django_python3_ldap', # pip install django-python3-ldap
...
ROOT_URLCONF = 'bbdev.urls'

# Moved wsgi.py to apache2 sub-directory for better security protection
WSGI_APPLICATION = 'bbdev.apache2.wsgi.application'
